...
export const vitaminDLevels: VitaminDLevel[] = [
  ...
  },
  {
    ...
    question: {
      ...
      sources: ["Revues biochimiques sur la synthèse de la vitamine D"]
    },
    sources: [
      {
  ...
  },
  {
    ...
    question: {
      ...
      sources: ["StatPearls: Physiology, Cortisol"]
    },
    sources: [
      {
  ...
  },
  {
    ...
    question: {
      ...
      sources: ["Hypothalamus-pituitary-thyroid axis interactions"]
    },
    sources: [
      {

...
export const antiInflammatoryUiTexts = {
  ...
  finalTitle: { fr: "🧠 Bravo.", en: "🧠 Well done." },
  finalMessage: { fr: "Votre compréhension est désormais moins inflammable.\nÀ bientôt pour de nouveaux thèmes à explorer et des combinaisons gagnantes à glisser dans vos assiettes…\n\nPromis, ici, les seules étincelles sont celles de vos connaissances ✨", en: "Your understanding is now less inflammatory.\nSee you soon for new topics to explore and winning combinations to slip onto your plates…\n\nPromise, here, the only sparks are those of your knowledge ✨" },

...
export const antiInflammatoryUiTexts = {
  ...
  finalTitle: { fr: "🧠 Niveau Expert atteint.", en: "🧠 Expert level reached." },
  finalMessage: { fr: "Votre compréhension est désormais moins inflammable.", en: "Your understanding is now less inflammatory." },
  followInstagram: { fr: "Suivez notre compte Instagram pour découvrir les prochains thèmes", en: "Follow our Instagram to discover upcoming topics" },

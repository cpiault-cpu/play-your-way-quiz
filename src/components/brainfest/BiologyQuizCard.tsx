...
import { biologyTranslations, biologyQuizzes } from "@/data/biologyQuizData";
import BiologyIcon from "./icons/BiologyIcon";

interface BiologyQuizCardProps {
  levelId: "1.1" | "1.2" | "1.3";
  language: Language;
  onPlay: (levelId: "1.1" | "1.2" | "1.3") => void;
}

const BiologyQuizCard = ({ levelId, language, onPlay }: BiologyQuizCardProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-grow flex items-center justify-center py-4">
        <BiologyIcon className="w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28" />
      </div>
...
export default BiologyQuizCard;

...
import { 
  ...
  biologyTranslations, 
  BiologyQuestion 
} from "@/data/biologyQuizData";
import { toast } from "sonner";
import { supabase } from "@/integrations/supabase/client";

const TIMER_DURATION = 30;

interface BiologyQuizGameProps {
  levelId: "1.1" | "1.2" | "1.3";
  language: Language;
  onBack: () => void;
}
...
const BiologyQuizGame = ({ levelId, language, onBack }: BiologyQuizGameProps) => {
  const t = biologyTranslations[language];
  const quiz = biologyQuizzes.find(q => q.levelId === levelId);
...
export default BiologyQuizGame;

...
const PlantsQuizCard = ({ level, language, onPlay, isCompleted }: PlantsQuizCardProps) => {
    ...
    switch (level) {
      case 1:
        return {
          ...
          description: { 
            fr: "Camomille, gingembre, menthe poivrée", 
            en: "Chamomile, ginger, peppermint" 
          },
          emoji: "🟢",
          color: "#7FB3A3",
      ...
      case 2:
        return {
          ...
          description: { 
            fr: "Curcuma, aloe vera, échinacée", 
            en: "Turmeric, aloe vera, echinacea" 
          },
          emoji: "🟠",
          color: "#E8A87C",
      ...
      case 3:
        return {
          ...
          description: { 
            fr: "Valériane, millepertuis, arnica", 
            en: "Valerian, St. John's wort, arnica" 
          },
          emoji: "🔴",
          color: "#D17B7B",

...
import { medicinalPlantsTranslations, medicinalPlantsQuizzes } from "@/data/medicinalPlantsQuizData";
import PlantIcon from "./icons/PlantIcon";

interface MedicinalPlantsQuizCardProps {
  levelId: "1.1" | "1.2" | "1.3";
  language: Language;
  onPlay: (levelId: "1.1" | "1.2" | "1.3") => void;
}

const MedicinalPlantsQuizCard = ({ levelId, language, onPlay }: MedicinalPlantsQuizCardProps) => {
...
export default MedicinalPlantsQuizCard;

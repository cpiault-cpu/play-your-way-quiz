...
import { 
  micronutritionQuizzes, 
  micronutritionTranslations, 
  MicronutritionQuestion 
} from "@/data/micronutritionQuizData";
...
const MicronutritionQuizGame = ({ levelId, language, onBack }: MicronutritionQuizGameProps) => {
  ...
  const handleStartQuiz = async () => {
    ...
    try {
      await supabase.from("signups").insert({
        email,
        quiz_id: `micronutrition-${levelId}`,
      });
    } catch (error) {
...
export default MicronutritionQuizGame;

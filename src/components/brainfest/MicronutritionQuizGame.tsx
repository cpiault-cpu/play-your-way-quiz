...
interface AnswerResult {
  question: MicronutritionQuestion;
...
const MicronutritionQuizGame = ({ level, language, onBack, onLevelComplete }: MicronutritionQuizGameProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 flex flex-col" style={{ fontFamily: 'Montserrat, sans-serif' }}>
      {/* Header */}
                ...
                {isPerfect ? (
                  <>
                    <p className="text-xl font-semibold text-foreground whitespace-pre-line mb-4">
                      {level === 3 ? successMessages.finalComplete[language] : successMessages.levelComplete[language]}
                    </p>
                  </>
                ) : (
